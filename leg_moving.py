...
offset = np.array([0.75 , 0.25 , 0 , 0.5]) #defines the offset between each foot step in this order (FR,FL,BR,BL)
...
while(True):
    ...
    bodytoFeet = trot.loop2(0.03, 2, offset, 0.05, bodytoFeet0)
    ...
    pwm.set_pwm(fright_shoulder, 0, 505)
    pwm.set_pwm(flleft_shoulder, 0, 505)
    pwm.set_pwm(bright_shoulder, 0, 505)
    pwm.set_pwm(blleft_shoulder, 0, 505)

    pwm.set_pwm(fright_femur, 0, 505)
    pwm.set_pwm(flleft_femur, 0, 505)
    pwm.set_pwm(bright_femur, 0, 505)
    pwm.set_pwm(blleft_femur, 0, 505)

    pwm.set_pwm(fright_tibia, 0, 555)
    pwm.set_pwm(flleft_tibia, 0, 555)
    pwm.set_pwm(bright_tibia, 0, 555)
    pwm.set_pwm(blleft_tibia, 0, 555)
